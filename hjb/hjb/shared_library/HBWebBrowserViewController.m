...
-(UIButton *)btn_close
{
    if (!_btn_close) {
        ...
        _btn_close.frame = CGRectMake(self.navigationbar.leftItem.right, self.navigationbar.leftItem.top, 50, 44.);
...
//        if(self.showsURLInNavigationBar) {
            ...
            self.navigationbar.title = URLString;
//        }
    }
    else {
//        if(self.showsPageTitleInNavigationBar) {
            if(self.wkWebView) {
                ...
                self.navigationbar.title = [self.uiWebView stringByEvaluatingJavaScriptFromString:@"document.title"];
            }
        }
//    }
}
