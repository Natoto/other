...
- (id)viewControllerForKey:(NSString *)key
{
    ...
    {
        HBRouterBlock objBlock = (HBRouterBlock)obj;
        vc = objBlock();
    }
...
#define KEY_PARAM_STYLE_SEPERATOR @"->"
//
//-(NSObject)is:(NSString *)key value:(id)value
//{
//    NSArray * compants = [key componentsSeparatedByString:@"->"];
//    if (compants.count == 2) {
//        if ([compants[1] rangeOfString:@"int"].location != NSNotFound) {
